...
def test_check_invariants_resolves_function_level_source(project_dir, base_modules):
    src = project_dir / "function_tool.py"
    src.write_text("def sample_tool(x):\n    return x + 1\n", encoding="utf-8")

    base_modules["modules"]["sample_tool"]["source"] = "function_tool.py::sample_tool"
